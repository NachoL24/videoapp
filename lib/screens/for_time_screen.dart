...
class ForTimeScreen extends StatefulWidget {
  ...
  const ForTimeScreen({super.key, this.colorTheme, this.deviceHeight, this.deviceWidth});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('For Time', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),),
        centerTitle: true,
      ),
      body: Center(
        child: Column(
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    countupProvider.setDuration(Duration(seconds: (int.parse(minutesValue)*60 + int.parse(secondsValue))));
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const Timer(timerType: TimerType.countup, )));
                  },
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    countupProvider.setDuration(Duration(seconds: (int.parse(minutesValue)*60 + int.parse(secondsValue))));
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const CameraPage(timerType: TimerType.countup)));
                  },
